...
datfile = 'merge_405samples_cellInfo_added_0908.h5ad'
dat = sc.read(datfile)
...
dat = sc.read("~path/merge_405Samples_raw1001.h5ad")
nkeep = 50
ambientList = []
...
dat = sc.read("~path/CellTypeAdded0828/merge_405samples_cellInfo_added_0908.h5ad")
mkrList = []
for i in sample2keep:
