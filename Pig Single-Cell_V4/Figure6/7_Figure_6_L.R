...
# --------------------- Load dataset ---------------------#
dfb <- read.csv("UG_1_percentage.csv",header=T,sep=",")
dfb$Group = factor(dfb$Group, levels=c('blank','0mg/L','1mg/L','10mg/L','50mg/L','105mg/L'))

# ---------- Create ggplot: visualize cell proliferation of human myogenic progenitors across groups ----------#
my_comparisons <- list(c("blank","0mg/L"),c("0mg/L","1mg/L"),c("0mg/L","10mg/L"),c("0mg/L","50mg/L"),c("0mg/L","105mg/L"))
...
ggsave(file=paste0('UG1_plot_2_final_t_test.pdf'),width =3,height = 4)